        ...
        <div className="w-full md:flex-1 2xl:max-w-[45rem] lg:max-w-[40rem]  max-w-full">
          ...
          {category && category !== "Select" && (
            <>
              ...
              <textarea className="w-full border-[#d6d5d5] border p-3 h-[10rem] bg-transparent mb-4" placeholder="" />
            </>
          )}
...
<textarea className="w-full border-[#d6d5d5] border p-3 bg-transparent h-[10rem] mb-4" placeholder="" />
          ...
          {category && category !== "Select" && (
            <>
              <label className="block text-gray-700 text-base mb-2 2xl:text-[1.2em]">Attachments</label>
              <div className="border border-[#d6d5d5] p-3 text-center cursor-pointer bg-white">
                <span className="text-primary cursor-pointer">Add files</span> or drop files here
                <input type="file" className="hidden" />
              </div>
              <button className="w-full md:w-[12rem] bg-primary mt-10 text-white py-3 rounded">Submit</button>
            </>
          )}
        </div>
