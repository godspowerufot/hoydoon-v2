...
{/* second div layout  */}
    <div className="bg-gray-100 p-4 rounded-lg">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center">
        {/* Left Section */}
        <div>
          <h2 className="text-[1.7rem] font-bricolage font-semibold">Adron Homes</h2>
 ...
 <div className="w-full border-t border-b border-[#8F8F8F] py-3">
    ...
    <div className="w-full px-4 py-6">
      <h2 className="text-2xl font-bold text-black font-bricolage">Home Highlights</h2>
    ...
    {/* description */}
    <div className=' w-full px-4 py-6'>
    <h2 className="text-2xl font-bold text-black font-bricolage">Description</h2>
<div>
    <p className=' text-[#8F8F8F] font-bricolage text-base w-[73rem] 2xl:w-full 2xl:text-xl pt-4'>This Craftsman Cottage in Lakewood Heights offers a perfect blend of timeless charm and modern updates. The home boasts beautiful hardwood floors, updated windows, and a bright, open kitchen equipped with granite countertops and stainless steel appliances, making it both stylish and practical. The master suite includes a recently renovated ensuite bathroom featuring a freestanding tub, a separate shower, and a double vanity for added comfort. A front bedroom doubles as a cozy home office, while the rare second living area provides extra flexibility for entertaining or relaxation.
    The spacious backyard features low-maintenance turf, a putting green, and an automatic driveway gate, creating an ideal outdoor retreat. Conveniently located within walking distance of Whole Foods and the shops and restaurants in Lakewood, this home is perfectly positioned for a vibrant lifestyle. Don’t miss your chance to own this exceptional property!</p>
</div>
    ...
    {/* listed by agent */}
    <div className=' w-full px-4 py-6'>
    <h2 className="text-2xl font-bold text-black font-bricolage">Listed  by Agent</h2>
<div className='mt-5'>
<ListedCard/>
</div>
    ...
    <span className="text-primary cursor-pointer ml-2">Remove map boundary</span>
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-3 gap-4 mt-6  2xl:text-base text-gray-700 text-sm">
        <div className="flex items-center gap-2">
          ...
          <span className="text-primary  font-medium">.... 5 mins</span> to Public Transit
        </div>
        <div className="flex items-center gap-2">
          <Image src="/bank.png" alt="Bank" width={20} height={20} />
          <span className="text-primary font-medium">.... 15 mins</span> to Bank
        </div>
        <div className="flex items-center gap-2">
          <Image src="/shopping.png" alt="Shopping" width={20} height={20} />
          <span className="text-primary font-medium">.... 20 mins</span> to Shopping mall
        </div>
        <div className="flex items-center gap-2">
          <Image src="/school.png" alt="School" width={20} height={20} />
          <span className="text-primary font-medium">.... 10 mins</span> to School
        </div>
        <div className="flex items-center gap-2">
          <Image src="/pharmacy.png" alt="Pharmacy" width={20} height={20} />
          <span className="text-primary font-medium ">.... 15 mins</span> to Pharmacy
        </div>
      </div>
    </div>
...
<section className="mt-10  hidden  2xl:mt-[4em] lg:mt-[3em] w-[75rem]  2xl:w-[88rem]  font-bricolage lg:flex justify-center flex-col flex-1 items-center">
      ...
      <h1 className="text-black  text-[26px] lg:text-[1.8rem] font-[600]   w-full ">  Single Family House Rents</h1>
