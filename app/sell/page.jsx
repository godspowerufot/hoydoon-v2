...
export default function Home() {
  ...
  return (
    <>
      <header className="relative  h-[60vh] lg:h-[80vh] w-screen">
      ...
      <section className="mt-10  hidden lg:my-[4em] w-full  font-bricolage lg:flex justify-center flex-row gap-7 2xl:gap-[3rem] flex-1 items-center">
        <div className="w-[24rem] h-[32rem] 2xl:w-[28rem]    rounded-[20px] bg-[#F9FAFB] overflow-hidden border border-none">
          {/* Image Section */}
          ...
          <div className="p-6  2xl:px-7">
            ...
            <Link href={"/sell/sell-home"}>
              <Button className="w-full 2xl:mt-[3rem] mt-8 text-base 2xl:text-xl h-[4rem] p-3">
                Get Started
              </Button>
            </Link>
          </div>
        ...
        <div className="w-[24rem] h-[32rem] 2xl:w-[28rem]   rounded-[20px] bg-[#F9FAFB] overflow-hidden border border-none">
          ...
          <div className="p-6">
            ...
            <p className="text-[#8F8F8F] text-sm lg:text-[14px] 2xl:text-base mt-5">
