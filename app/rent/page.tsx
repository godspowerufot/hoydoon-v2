...
export default function Home() {
  ...
  <header className="relative h-[80vh] w-full overflow-hidden">
        ...
        <div className="flex flex-col items-center relative z-[1]  mt-[6rem]   gap-4 h-full ">
          ...
          Find Your Future, Feel at Home!          </h1>

          {/* Subheading */}
          <h2 className="text-[#FFFFFFB2] text-center  flex item-center justify-center font-[300] text-[clamp(1em,2vw,1.4em)] w-[47rem]">
          Find the perfect place for you and your loved ones, where comfort, community, and convenience come together.          </h2>
      ...
      <div className="flex   p-2 flex-col md:flex-row  2xl:gap-[9rem] my-[2rem] lg:flex-row    justify-around items-center  md:items-start ">
      <h1 className="text-black lg:-pl-[1rem]   text-[26px] lg:text-[2.5rem] font-[600]   w-full ">Newest Listings</h1>
...
<div className=" flex mt-[1em]   items-center lg:flex-row    justify-center  mb-1">
...
<div className=" flex mt-[4em]    min-w-fit items-center lg:flex-row    justify-center  mb-5">
  {/* Horizontal Scrollable Container on Mobile */}
    {/* Card 1 */}
  ...
  <p className="text-[#09858D]   ml-6 2xl:ml-8  my-5 text-2xl font-[500] ">see 2500 new listings for rent</p>
  </div>
...
<section className="mt-10  hidden  2xl:mt-[5em] lg:my-[3em] w-full  font-bricolage lg:flex justify-center flex-col flex-1 items-center">
      ...
      <h1 className="text-black lg:ml-5  2xl:ml-9 text-[26px] lg:text-[2.5rem] font-[600]   w-full ">  Explore Lagos Rentals</h1>
...
<section className="mt-10  hidden  2xl:my-[2em] lg:my-[2em] w-full  font-bricolage lg:flex justify-center flex-col flex-1 items-center">
      ...
      <h1 className="text-black lg:ml-4  2xl:pl-[2rem] text-[26px] lg:text-[2.5rem] font-[600]   w-full ">  pet-friendly Rental</h1>
      <p className="text-gray  lg:p-0 text-base lg:text-xl font-bricolage w-full lg:w-[50rem]">
      Discover a home where every detail enhances your lifestyle-crafted to fit your taste and needs.
</p>
...
<div className=" flex mt-[1em]   min-w-fit items-center lg:flex-row    justify-center  mb-2">
  ...
  <p className="text-[#09858D] 2xl:ml-[2.5rem]  ml-6   mt-5 text-2xl font-[500] ">See all 2500 pet-friendly houses for rent</p>
  </div>
...
<div className=" flex mt-[1em]   min-w-fit items-center lg:flex-row    justify-center  mb-2">
  ...
  <p className="text-[#09858D]   lg:ml-[2.3rem] 2xl:ml-[2.5rem]  mt-5 text-2xl font-[500] ">See all 2500 single family House rents for rent</p>
  </div>
