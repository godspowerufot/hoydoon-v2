...
const PropertyListCard: React.FC<PropertyCardProps> = ({ imageSrc, altText, price, area }) => {
  ...
  return (
    ...
    <div
    className={`flex flex-col rounded-[1.5rem]    h-[37rem] 2xl:h-[40rem] lg:w-[24rem] 2xl:w-[30rem] font-bricolage snap-center shrink-0 cursor-pointer overflow-hidden ml-8 relative 
