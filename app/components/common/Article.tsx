          ...
          <div className="flex flex-wrap gap-3 mt-1">
            <div className="flex">
              <span className="flex flex-col text-gray lg:text-[18px] text-sm -gap-2 lg:gap-2 font-medium">
                ...
                <h4 className=" text-[12px] lg:text-[18px]">{article.date.split(" ")[1]}</h4>
              </span>
...
const ArticlesSection = () => {
  return (
    <section className="flex  mt-[2rem] text-start lg:justify-center items-center w-full flex-col lg:my-[3rem]   p-2 lg:p-0 font-bricolage">
