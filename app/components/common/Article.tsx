...
const ArticlesSection = () => {
  return (
    <section className="flex  mt-[2rem] lg:-mt-[2em] text-start lg:justify-center items-center w-full flex-col   lg:max-w-[1200px] p-2 lg:p-0 font-bricolage">
      ...
      <div className="lg:flex  hidden justify-center w-full lg:mt-[2.5em]  lg:mb-[4em]  lg:flex-1 lg:flex-row flex-col items-center lg:gap-6 ">
