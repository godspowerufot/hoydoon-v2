...
import { COUNTRY_FILTER_OPTIONS, COUNTRY_LABELS } from "@/app/components/search/searchUtils";
...
export function FiltersDropdown({
  ...
  const selectedCountryLabel = filters.region
    ? COUNTRY_LABELS[filters.region] || filters.region
    : "All countries";
      ...
      >
        ...
        <div className="flex-1 overflow-y-auto px-5 py-6 md:px-6">
          <section className="mb-8">
            <h3 className={sectionLabelClass}>Country</h3>
            <p className="mt-2 text-sm text-[#5c5c66]">
              Filter listings by region — Nigeria, Kenya, or Somalia.
            </p>
            <div className="mt-3 flex flex-wrap gap-2">
              {COUNTRY_FILTER_OPTIONS.map((option) => {
                const selected = (filters.region || "") === option.value;
                return (
                  <button
