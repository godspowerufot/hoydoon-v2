...
const guides = [
  {
    ...
    title: "Should you use an agent when renting?",
    readTime: "3 min read",
    date: "March 2025",
    description:
      "How agents help with viewings, lease terms, and local market knowledge when you are searching for a rental.",
  },
  {
    ...
    date: "March 2025",
    description:
      "Flag inaccurate details or policy issues on a rental listing and learn what happens after you submit a report.",
  },
];

export default function RentGuides() {
  return (
    <section className="home-bleed bg-[#f7f7f8] py-14 md:py-20" aria-labelledby="rent-guides-heading">
      <HomeContainer>
        <SectionHeader
          headingId="rent-guides-heading"
          eyebrow="Renter guides"
          title="Know what to expect before you sign"
          description="Short reads on agents, listings, and the rental process, written for people making a real decision."
