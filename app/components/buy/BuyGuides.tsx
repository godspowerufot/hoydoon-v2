...
const guides = [
  {
    ...
    date: "March 2025",
    description:
      "When an agent is worth it, what they handle for buyers, and how to choose one in your market.",
  },
  {
...
export default function BuyGuides() {
  return (
    <section className="home-bleed bg-[#f7f7f8] py-14 md:py-20" aria-labelledby="buy-guides-heading">
      <HomeContainer>
        <SectionHeader
          headingId="buy-guides-heading"
          eyebrow="Buyer guides"
          title="Know what to expect before you offer"
          description="Short reads on agents, listings, and the buying process, written for people making a real decision."
