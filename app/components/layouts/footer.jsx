...
const Appfooter = () => {
 ...
 const pathname=usePathname()
  ...
  return (
    ...
    <>
    {!hideNavbar &&
    <footer className="bg-primary font-bricolage max-md:h-[42vh]  w-screen px-4 lg:p-0  text-white flex flex-col justify-center 2xl:mt-[14rem] items-center lg:mt-[5rem]">
 ...
 <div>
              ...
              <ul className="mt-1 lg:mt-[4px] space-y-2   text-[#F4F4F4] text-[12px] lg:text-sm">
                ...
                <li>
                  <Link href="/helpcenter/submit-request" className="transition hover:opacity-75">
                 help center
                  </Link>
                </li>
              </ul>
