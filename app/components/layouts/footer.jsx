...
const Appfooter = () => {
 ...
 const pathname=usePathname()
  ...
  return (
    ...
    <>
    {!hideNavbar &&
    <footer className="bg-primary font-bricolage max-md:h-[50vh]  w-screen px-4 lg:p-0  text-white flex flex-col justify-center 2xl:mt-[14rem] items-center lg:mt-[5rem]">
      <div className="w-[95%] 2xl:w-[100rem]  2xl:flex 2xl:items-center 2xl:flex-col 2xl:justify-center space-y-8  mt-[2rem] lg:px-9   lg:py-16 sm:px-6 lg:space-y-16 ">
        {/* Top Section */}
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
          ...
          <div>
            <div className="flex flex-col 2xl:ml-5 items-start  w-[50em] lg:w-0">
              ...
              <div className="flex items-center py-2 lg:w-[460px]  max-md:w-[35%] h-[43px] lg:h-[60px] rounded-[50px] border border-[#F9FAFB] pl-3 pr-1 mt-4">
                <input
                  type="email"
                ...
                />
                <button className="ml-2 lg:w-[11em] lg:h-[3.2em]  text-sm  lg:text-base flex items-center justify-center h-[2.3rem] p-4 lg:p-0 max-md:ml-[-3.9rem]  bg-white text-black font-medium rounded-full px-4">
                   Subscribe
                </button>
              </div>
            </div>
 ...
 <div>
              ...
              <ul className="mt-1 lg:mt-[4px] space-y-2   text-[#F4F4F4] text-[12px] lg:text-sm">
                ...
                <li>
                  <Link href="/helpcenter/submit-listing" className="transition hover:opacity-75">
                 help center
                  </Link>
                </li>
              </ul>
      ...
      />
        ...
        <div className="flex flex-col-reverse lg:flex-row  w-[100%] 2xl:max-w-[100vw]  justify-end lg:justify-between items-center gap-4 2xl:px-0 text-base">
          <p className="text-center font-[300] hidden lg:block">&copy; 2022. Company Name. All rights reserved.</p>
