...
export default function FagsSection() {
  return (
    <section className=" mt-[20px]  md:mt-[3rem]  w-full     flex flex-1 justify-center items-center  flex-col   p-2 md:p-0 font-bricolage ">
      ...
      <div className="-mt-[4.3rem] md:-mt-[3em] md:mb-[5.5em]  md:ml-[5rem]   justify-center items-center max-md:w-full w-full gap-6 flex flex-col-reverse max-md:justify-center max-md:items-center md:flex-row ">
