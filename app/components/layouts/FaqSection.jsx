...
export default function FagsSection() {
  return (
    <section className=" mt-[20px]  lg:mt-0  w-full     flex flex-1 justify-center items-center  flex-col   p-2 lg:p-0 font-bricolage ">
      ...
      <div className="-mt-[3rem] lg:-mt-[2rem] lg:mb-[5em]  lg:ml-[5rem]   justify-center items-center max-md:w-full w-full gap-6 flex flex-col-reverse max-md:justify-center max-md:items-center lg:flex-row ">
