      ...
      <div className="hidden lg:flex justify-center items-center">
        <div className="flex h-[3.5em] py-4 font-bricolage items-center m-2 bg-white rounded-full w-10/12 md:w-4/5 lg:w-[35em]">
          <input
            ...
            className="flex-1 !bg-transparent placeholder:text-xl text-xl text-black placeholder-gray-500 border-none outline-none placeholder:bg-none pl-4 w-[36.3rem]"
          />
          <div
