...
const guides = [
  {
    ...
    title: "Do I need a real estate agent to sell a home?",
    readTime: "3 min read",
    date: "March 2025",
    description:
      "When an agent is worth it, what they handle for sellers, and how to choose one in your market.",
  },
  {
...
export default function SellGuides() {
  return (
    <section className="home-bleed bg-[#f7f7f8] py-14 md:py-20" aria-labelledby="sell-guides-heading">
      <HomeContainer>
        <SectionHeader
          headingId="sell-guides-heading"
          eyebrow="Seller guides"
          title="Know what to expect before you list"
          description="Short reads on agents, pricing, and the selling process, written for people making a real decision."
